...
#     index_error = "`{}` is not a valid term in the term-list."

#     def __init__(self, text_tuple):
#         self.text_tuple = text_tuple

#     def index(self, term):
#         try:
#             return self.text_tuple.index(term)
#         except:
#             print(self.index_error.format(term))
#             raise

#     def parse(self, myid):
#         return self.text_tuple[myid]

#     def iterparse(self, iterids):
#         return tuple([self.parse(myid) for myid in iterids])

# Meals = TextParser(MEAL_NAMES)
# Characters = TextParser(CHAR_NAMES)
# MealCategories = TextParser(MEAL_CATEGORIES)
# SharedIngredientRecords = TextParser(INGREDIENT_NAMES)
# LostItems = TextParser(LOST_ITEM_NAMES)
# Months = TextParser(MONTH_NAMES)
# MonestaryLocations = TextParser(MONESTARY_LOCATION_NAMES)

# def ideal_meal_shares(char_sel_one, char_sel_two=None, return_text=False):
#     if not isinstance(char_sel_one, int):
#         char_sel_one = Characters.index(char_sel_one.title())
#         return_text = True
#     if char_sel_two and not isinstance(char_sel_two, int):
#         char_sel_two = Characters.index(char_sel_two.title())
#         return_text = True
#     valid_second_chars = set()
#     share_meal_opts = set()
#     for mealid, meal_chars in MEALPICKS_IDX.items():
#         if char_sel_one in meal_chars:
#             if char_sel_two is None:
#                 valid_second_chars.update(meal_chars)
#                 share_meal_opts.add(mealid)
#             else:
#                 if char_sel_two in meal_chars:
#                     share_meal_opts.add(mealid)
#     valid_second_chars = valid_second_chars - set([char_sel_one])
#     if not return_text:
#         return share_meal_opts, valid_second_chars
#     else:
#         return (
#             Meals.iterparse(share_meal_opts),
#             Characters.iterparse(valid_second_chars))


# def meal_ingredients(mealid):
#     return MEAL_RECEPIES_IDX[mealid]
